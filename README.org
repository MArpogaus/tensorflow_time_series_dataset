...
1. Fork the Project
2. Create your Feature Branch (Symbol's value as variable is void: git)
3. Commit your Changes (Symbol's value as variable is void: git)
4. Push to the Branch (Symbol's value as variable is void: git)
